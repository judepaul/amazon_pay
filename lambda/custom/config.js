...
// GLOBAL
    const appID                         = 'amzn1.ask.skill.eaea135e-3a94-4f55-a2a8-dc5c6778928b';           // Required; Alexa Skill ID
    const sellerId                      = 'A3UTMAA9OENYKK';                                                  // Required; Amazon Pay seller ID; Used for both Setup and Process Payment
...
// SETUP    
    ...
    const needAmazonShippingAddress     = false;                                                             // Optional; Must be boolean;
    const sandboxCustomerEmailId        = 'jude@seedcube.com';              // Optional; Required if sandboxMode equals true; Must setup Amazon Pay test account first;
...
// SELLER ORDER ATTRIBUTES
    const customInformation           	= '';                      		 	// Optional; Max 1024 chars
    const sellerNote                  	= '';										// Optional; Max 1024 chars
    const sellerOrderId               	= '';                            		 	// Optional; Merchant specific order ID
...
// ADDITIONAL ATTRIBUTES
	...
	const sellerBillingAgreementId 		= utilities.generateRandomString(6); 																// Optional; The merchant-specified identifier of this billing agreement
